...
print("--------------------------AXIS SUM across a 3D ARRAY---------------------------")
...
print("--------------------------AXIS SUM across a 4D ARRAY---------------------------")
...
print("--------------------------AXIS CONCATENATE two 3D ARRAYS---------------------------")
arr3 = np.random.randint(0, 10, (2,3,2))
print("arr3 =[[", arr3[0,0], arr3[0,1], arr3[0,2], "]")
print("       [", arr3[1,0], arr3[1,1], arr3[1,2], "]]")
...
print("--------------------------AXIS CONCATENATE two 4D ARRAYS---------------------------")
arr4 = np.random.randint(0, 10, (2,2,3,2))
print("arr4", arr4)
...
print("--------------------------AXIS ADD two 3D ARRAYS---------------------------")

print("arr3 =[[", arr3[0,0], arr3[0,1], arr3[0,2], "]")
print("       [", arr3[1,0], arr3[1,1], arr3[1,2], "]]")
print("arr32 =[[", arr32[0,0], arr32[0,1], arr32[0,2], "]")
print("       [", arr32[1,0], arr32[1,1], arr32[1,2], "]]")
print("np.sum(arr3, arr32, axis=0)", np.sum((arr3, arr32), axis=0))
print("np.sum(arr3, arr32, axis=1)", np.sum((arr3, arr32), axis=1))
print("np.sum(arr3, arr32, axis=2)", np.sum((arr3, arr32), axis=2))
